        ...
        <section className="section-wrap bg-[#191919] overflow-hidden z-50">
            <div className="wraper">
                <div className="max-w-[640px] mx-auto text-center text-white mb-[60px] md:mb-[40px]">
                    ...
                    <p className="base-font text-lg font-normal">Flexible pricing plans built to help businesses grow with reliable 
                        web development and digital marketing solutions.</p>
                </div>
                <div className="grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
                    <div className="bg-[#262626] md:mb-[30px] sm:mx-[60px] col:mx-[0px] text-center mx-3">
                        <div className="px-5">
                            ...
                            <h2
                                ...
                                $300<span className="font-medium text-[#D8D8D8] ml-[2px] text-base inline-block "> / 5 pages
                            </span></h2>
                            <p className="pb-7 max-w-[282px] mx-auto text-[#D8D8D8] border-b border-[#496451]">Best for wordpress websites and portfolios.</p>
                        </div>
                        <div className="p-10 pt-9 list-none">
                            <ul>
                                <li className="text-[#D8D8D8] mb-4 text-base">User Story</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">Web Development</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">Basic SEO</li>
                    ...
                    <div className="bg-[#262626] md:mb-[30px] sm:mx-[60px] col:mx-[0px] text-center mx-3">
                        <div className="px-5">
                            ...
                            <h2
                                className="mt-7 mb-4 font-bold text-[45px] md:text-[30px] flex items-center justify-center text-white uppercase">
                                $1000<span className="font-medium text-[#D8D8D8] ml-[2px] text-base inline-block "> / 10 Pages</span></h2>
                            <p className="pb-7 max-w-[282px] mx-auto text-[#D8D8D8] border-b border-[#496451]">Best for business websites and e-commerce platforms.</p>
                        </div>
                        <div className="p-10 pt-9 list-none">
                            <ul>
                                <li className="text-[#D8D8D8] mb-4 text-base">User Story</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">Web Development</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">PRO SEO Service.</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">Graphic Design</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">24/Support</li>
                            </ul>
                            <Link to="/" className="theme-btn-2 mt-5">CHOOSE PLAN</Link>
                    ...
                    <div className="bg-[#262626]  text-center sm:mx-[60px] col:mx-[0px] mx-3">
                        <div className="px-5">
                            ...
                            <h2
                                className="mt-7 mb-4 font-bold text-[45px] md:text-[30px] flex items-center justify-center text-white uppercase">
                                $2000<span className="font-medium text-[#D8D8D8] ml-[2px] text-base inline-block "> & Above</span></h2>
                            <p className="pb-7 max-w-[282px] mx-auto text-[#D8D8D8] border-b border-[#496451]">Best for web applications and mobile applications..</p>
                        </div>
                        <div className="p-10 pt-9 list-none">
                            <ul>
                                <li className="text-[#D8D8D8] mb-4 text-base">Figma Design</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">Fullstack Development</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">Deployments</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">Graphic Design</li>
                                <li className="text-[#D8D8D8] mb-4 text-base">24/Support</li>
                            </ul>
                            <Link to="/" className="theme-btn-2 mt-5">CHOOSE PLAN</Link>
